...
- **Research-driven backlog (2026-08-16, from docs/competitive-research.md):**
  - QUICK WINS (in progress): redirect chain detection at create time; listing-copy sharpening (zero false positives / real-301s-never-JS / unmetered logging / AI framing for migration matcher)
